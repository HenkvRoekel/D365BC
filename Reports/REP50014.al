report 50014 "Sales - Proforma Inv Bejo"
{

    DefaultLayout = RDLC;
    RDLCLayout = './RDLC/Sales - Proforma Inv Bejo.rdlc';
            ...
            dataitem(CopyLoop; "Integer")
            {
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    dataitem("Sales Line"; "Sales Line")
                    {
                        ...
                        column(ExternalDocNo_SalesLine; "Sales Line"."B External Document No.")
                        {
                            IncludeCaption = true;
                        }
    ...
    var
        ...
        Text119: Label 'Proforma Invoice';
        ...
        Text314: Label 'Country of Origin';
    ...
    begin
        ...
        exit(
          ...
          '' + Format(Char177) +       //(8,3)
          '' + Format(Char177) +       //(9,3)
          Text310 + Format(Char177) +  //(10,3)
          Text311 + Format(Char177) +  //(11,3)
          '' + Format(Char177) +       //(12,3)
          Text312 + Format(Char177) +  //(13,3)//BEJOW110.00.026 119352
          Text314 + Format(Char177) +  //(14,3)
    ...
    begin
        ...
        "Sales Header"."No." + Format(Char177) +                          //(6,2)
        Text109 + Format(Char177) +                                       //(7,2)
        Format(WorkDate) + Format(Char177) +                              //(8,2)
        "Sales Header".FieldCaption("Shipment Date") + Format(Char177) +  //(9,2)
        Format("Sales Header"."Shipment Date") + Format(Char177) +        //(10,2)
        '' + Format(Char177) +                                            //(11,2)
        ...
        "Sales Header".FieldCaption("VAT Registration No.") + ' ' + "Sales Header"."VAT Registration No." + Format(Char177) +   //(20,2)
        ...
        ShipToAddr[6] + Format(Char177) +                                 //(27,2)
        "Sales Header"."External Document No." + Format(Char177) +        //(28,2)
        Text312 + Format(Char177) +                                       //(29,2)
          ' '
          );
    end;
    ...
    begin
        ...
        exit(
          ...
          Format("Sales Header"."B Gross weight") + Format(Char177) +     //(2,4)
          Text403 + Format(Char177) +                                     //(3,4)
          Format("Sales Header"."B Reserved weight") + Format(Char177) +   //(4,4)
          ...
          "Sales Header"."Payment Method Code" + Format(Char177) +        //(14,4)
