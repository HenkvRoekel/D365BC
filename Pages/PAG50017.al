page 50017 "Stock Info Stock FactBox"
{
    ...
    layout
    {
        area(content)
        {
            ...
            {
                Caption = 'Stock';
                field("Open Stock"; TotalOpenStock)
                {
                    DecimalPlaces = 0 : 0;
                    Editable = false;
                    ApplicationArea = All;
                ...
                field("Total Stock"; TotalTotalStock)
                {
                    DecimalPlaces = 3 : 3;
                    Editable = false;
                    ApplicationArea = All;
                }
                field("Total Stock KG"; TotalTotalStockKG)
                {
                    DecimalPlaces = 3 : 3;
                    Editable = false;
                    ApplicationArea = All;
                ...
                field("Res KG"; TotalResKG)
                {
                    DecimalPlaces = 3 : 3;
                    Editable = false;
                    ApplicationArea = All;
                }
                field(Open; TotalOpen)
                {
                    DecimalPlaces = 3 : 3;
                    Editable = false;
                    ApplicationArea = All;
                }
                field("Open KG"; TotalOpenKG)
                {
                    DecimalPlaces = 3 : 3;
                    Editable = false;
                    ApplicationArea = All;
                }
                field("Open stock 1"; TotalOpenstock1)
                {
                    DecimalPlaces = 0 : 0;
                    Editable = false;
                    ApplicationArea = All;
                }
                field("Open stock KG"; TotalOpenstock1KG)
                {
                    DecimalPlaces = 0 : 2;
                    Editable = false;
                    ApplicationArea = All;
                }
                field("Stock 1"; TotalStock1)
                {
                    DecimalPlaces = 3 : 3;
                    Editable = false;
                    ApplicationArea = All;
                }
                field("Stock 1 KG"; TotalStock1KG)
                {
                    DecimalPlaces = 3 : 3;
                    Editable = false;
                    ApplicationArea = All;
