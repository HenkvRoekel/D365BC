page 50018 "Stock Information"
{
    ...
    layout
    {
        area(content)
        {
            ...
            part("Lot Information"; "Stock Information sub 1")
            {
                Caption = 'Lot Information';
                Editable = false;
                SubPageLink = "B Variety" = FIELD ("No.");
                SubPageView = SORTING ("B Variety")
                              WHERE ("B Remaining Quantity" = FILTER (> 0));
                ApplicationArea = All;
            }
            part("Item Unit"; "Stock Information sub 2")
            {
                Caption = 'Prognoses / Allocation';
                Editable = false;
                SubPageLink = Variety = FIELD ("No."),
                              "Date Filter" = FIELD ("Date filter");
                SubPageView = SORTING ("Item No.", "Unit of Measure");
                ApplicationArea = All;
            }
            ...
            part("Sales Line"; "Stock Information sub 4")
            {
                Caption = 'Sales Line';
                SubPageLink = "B Variety" = FIELD ("No.");
                SubPageView = SORTING ("Document Type", Type)
                              WHERE ("Document Type" = CONST (Order));
                ApplicationArea = All;
            }
            part("Purchase Line"; "Stock Information sub 5")
            {
            ...
            part("Blanket Order"; "Stock Information sub 4")
            {
            ...
            part(Quote; "Stock Information sub 4")
            {
                Caption = 'Sales Quote';
                SubPageLink = "B Variety" = FIELD ("No.");
                SubPageView = SORTING ("Document Type", Type)
            ...
            part(Control1000000028; "Purch. Ord. Preview as subform")
            {
                SubPageLink = Variety = FIELD ("No.");
                ApplicationArea = All;
            }
        ...
        area(factboxes)
        {
            part("Variety Info"; "Stock Info Variety FactBox")
            {
                Caption = 'Variety Info';
                SubPageLink = "No." = FIELD ("No.");
                ApplicationArea = All;
            }
            part(Control6; "Stock Info Stock FactBox")
            {
                Caption = 'Lot Information';
                SubPageLink = "No." = FIELD ("No.");
                ApplicationArea = All;
            }
            part("Prognoses / Allocation"; "Stock Info Progn/Alloc FactBox")
            {
                Caption = 'Prognoses / Allocation';
                SubPageLink = "No." = FIELD ("No.");
                ApplicationArea = All;
