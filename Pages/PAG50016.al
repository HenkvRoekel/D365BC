page 50016 "Stock Info Variety FactBox"
{
    ...
    layout
    {
        area(content)
        {
            ...
            field("GetFilter(""Date filter"")"; GetFilter("Date filter"))
            {
                Caption = 'Date Filter';
                Editable = false;
                ApplicationArea = All;
            }
            field(PromoStatusText; PromoStatusText)
            {
                Caption = 'Promo Status';
                Editable = false;
                ApplicationArea = All;
            }
            field("lcuBlockingMgt.VarietyBlockDescription(Rec)"; lcuBlockingMgt.VarietyBlockDescription(Rec))
            {
