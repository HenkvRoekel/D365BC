    ...
    layout
    {
        area(content)
        {
            repeater(Group)
            {
                ...
                field("Average Cost Exception"; "Average Cost Exception")
                {
                    ApplicationArea = All;
                }
                ...
                field("B Unit in Weight"; "B Unit in Weight")
                {
                    ApplicationArea = All;
                }
                ...
                field(YR; Date2DWY("Posting Date", 3))
                {
                    ApplicationArea = All;
                }
                field(WK; Date2DWY("Posting Date", 2))
                {
                    ApplicationArea = All;
                }
                field(MM; Date2DMY("Posting Date", 2))
                {
                    ApplicationArea = All;
                }
                ...
                field(Name; gRecCustomer.Name)
                {
                    ApplicationArea = All;
                }
                field("Name 2"; gRecCustomer."Name 2")
                {
                    ApplicationArea = All;
                }
                field(Address; gRecCustomer.Address)
                {
                    ApplicationArea = All;
                }
                field(City; gRecCustomer.City)
                {
                    ApplicationArea = All;
                }
                ...
                field("Phone No"; gRecCustomer."Phone No.")
                {
                    ApplicationArea = All;
                }
                ...
                field("Payment Terms Code"; gRecCustomer."Payment Terms Code")
                {
                    ApplicationArea = All;
                }
                field("Description 2"; fnDescription2("Item No."))
                {
                    ApplicationArea = All;
                }
                ...
                field("Item Description 2"; gRecItem."Description 2")
                {
                    ApplicationArea = All;
                }
                ...
                field("Code BejoNL"; gRecUOM."B Code BejoNL")
                {
                    ApplicationArea = All;
                }
                ...
                field(SalesAmt_CR; gDecSalesAmt_CR)
                {
                    ApplicationArea = All;
                }
                field(SalesAmt_INV; gDecSalesAmt_INV)
                {
                    ApplicationArea = All;
                }
                field(SalesAmt_ADJ; gDecSalesAmt_ADJ)
                {
                    ApplicationArea = All;
                }
                field(KG; gDecKG)
