page 50173 "Scan Transit To"
{

    Caption = 'Scan Transit To';
    DeleteAllowed = false;
    ...
    var
        ...
        LotNos: Text;
        ctxtLotsScanned: Label 'Lot(s) %1 in transit (is)(are) placed in %2.';
    ...
    var
        ...
        ctxtNoBinForLot: Label 'No Transit Bin found for Lot %1.';
        ctxtLot: Label 'Lot: %1';
        ctxtBins: Label ' / Bin:';
        ctxtLocation: Label 'Location: ';
        ...
        if ScanField <> '' then begin
            ...
            if LotNoInf.IsEmpty then begin
                ...
                if LotNoInf.FindSet then repeat
                                             ...
                                             WarehouseEntry.SetRange("Bin Code", BEJOSetup."Transit Bin");
                                             ...
                                             if LotNoInf."Lot No." = TmpLotNoInf."Lot No." then
                ...
                if TmpBin.Count <> 0 then begin
                    ...
                    InfoMessage := StrSubstNo(ctxtNoBinForLot, ScanField);
    ...
    begin
        BinContent.Reset;
        BinContent.SetRange("Bin Code", BEJOSetup."Transit Bin");
        BinContent.SetRange("Item No.", LotNoInf."Item No.");
        ...
        ScanPage.UpdateSalesLines(LotNoInf."Lot No.", BinCode);
    ...
    begin
        with ItemJournalLine do begin
            ...
            Validate("Bin Code", BEJOSetup."Transit Bin");
            Validate("Variant Code", TheBinContent."Variant Code");
            if GetUOM(TmpLotNoInf, ILEUnitOfMeasureCode, ILEUnitQtyPerOfMeasure) then begin
                if ILEUnitQtyPerOfMeasure <> 0 then
            ...
            "B Scanning" := true;
            Validate("Lot No.", TmpLotNoInf."Lot No.");
